...
export default function ProjectButton({ id, name, date, languages, selectedSkill, featured }: { id: string, name: string, date: string, languages: Array<string>, selectedSkill?: string, featured: boolean }) {

...
export default function Home() {
  ...
  return (
    <Layout mainPage title="About Me" description="Hey, I'm Seb!" image={`/assets/SVG${pathname}.svg`} prev="/" next="/experience" pageIdx={2} overrideMetaDescription="Learn more about me">
      <Head>
